...
(define (compile exp target linkage)
  (cond ((self-evaluating? exp)
        ...
        (else
         (error "Unknown expr type: COMPILE" exp))))
...
;; factorial
;; (define fact-comp (compile '(define (fact n) (if (= n 1) 1 (* (fact (- n 1)) n))) 'val 'next))
;; (display (caddr fact-comp))
